...
t_array = np.linspace(P.t_start, P.t_end,
                      length)  #The time vector that is passed into the ode
STATES = scipy.integrate.odeint(ctrl.cartpendfunc,
                                [P.z0, P.zdot0, P.theta0, P.thetadot0],
                                t_array)  #Solve non-linear dynamics
