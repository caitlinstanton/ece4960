...
class Robot():
    ...
    def send_to_plot(self, x, y, plot_type):
        self.traj_pub.publish(x, y, plot_type)

    def initialize(self):
        rospy.init_node('lab6_robot_controller', anonymous=True)
