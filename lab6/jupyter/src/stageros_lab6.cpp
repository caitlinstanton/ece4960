...
StageNode::SubscribeModels()
{
	...
	// TODO - print the topic names nicely as well
        ...
        new_robot->sim_pose_pub = n_.advertise<lab6::SimPose>(mapName(SIM_POSE, r, static_cast<Stg::Model*>(new_robot->positionmodel)), 10);
...
StageNode::WorldCallback()
{
  if( ! ros::ok() ) {
    ...
    for (size_t r = 0; r < this->robotmodels_.size(); ++r)
    {
        ...
        Stg::Pose IMU_error(0.03 * (drand48() - 0.5),
                            0.03 * (drand48() - 0.5),
                            0.0,
                            0.02 * (drand48() - 0.5));
