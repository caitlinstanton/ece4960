...
StageNode::SubscribeModels()
{
	...
	// TODO - print the topic names nicely as well
        ...
        new_robot->sim_pose_pub = n_.advertise<lab7::SimPose>(mapName(SIM_POSE, r, static_cast<Stg::Model*>(new_robot->positionmodel)), 10);
